...
func (kvh *kubeletVolumeHost) GetCinderConfig() string {
	return kvh.kubelet.cinderConfig
}

func (kvh *kubeletVolumeHost) IsNoMountSupported() bool {
	return kvh.kubelet.GetRuntime().Type() == "hyper"
}
