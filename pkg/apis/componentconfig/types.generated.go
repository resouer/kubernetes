		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if false {
					...
					r.EncodeBool(bool(x.DisableHyperInternalService))
				}
			} else {
				z.EncSendContainerState(codecSelfer_containerMapKey1234)
				r.EncodeString(codecSelferC_UTF81234, string("DisableHyperInternalService"))
				z.EncSendContainerState(codecSelfer_containerMapValue1234)
				yym11 := z.EncBinary()
				_ = yym11
				if false {
...
func (x *KubeProxyConfiguration) codecDecodeSelfFromMap(l int, d *codec1978.Decoder) {
	...
	for yyj3 := 0; ; yyj3++ {
		...
		case "DisableHyperInternalService":
			if r.TryDecodeAsNil() {
				x.DisableHyperInternalService = false
			} else {
				x.DisableHyperInternalService = bool(r.DecodeBool())
			}
...
func (x *KubeletConfiguration) CodecEncodeSelf(e *codec1978.Encoder) {
	...
	if x == nil {
		...
		if false {
			...
			_, _, _ = yysep2, yyq2, yy2arr2
			const yyr2 bool = false
			yyq2[51] = x.CloudProvider != ""
			yyq2[52] = x.CloudConfigFile != ""
			yyq2[53] = x.KubeletCgroups != ""
			yyq2[54] = x.RuntimeCgroups != ""
			yyq2[55] = x.SystemCgroups != ""
			yyq2[56] = x.CgroupRoot != ""
			yyq2[58] = true
			yyq2[59] = x.RktPath != ""
			yyq2[60] = x.RktAPIEndpoint != ""
			yyq2[61] = x.RktStage1Image != ""
			yyq2[82] = true
			yyq2[83] = x.NodeIP != ""
			yyq2[87] = x.EvictionHard != ""
			yyq2[88] = x.EvictionSoft != ""
			yyq2[89] = x.EvictionSoftGracePeriod != ""
			yyq2[90] = true
			yyq2[91] = x.EvictionMaxPodGracePeriod != 0
			var yynn2 int
			if yyr2 || yy2arr2 {
			...
			if yyr2 || yy2arr2 {
				...
				if false {
					...
					r.EncodeString(codecSelferC_UTF81234, string(x.CinderConfig))
				}
			} else {
				z.EncSendContainerState(codecSelfer_containerMapKey1234)
				r.EncodeString(codecSelferC_UTF81234, string("CinderConfig"))
				z.EncSendContainerState(codecSelfer_containerMapValue1234)
				yym8 := z.EncBinary()
				_ = yym8
				if false {
			...
			if yyr2 || yy2arr2 {
				z.EncSendContainerState(codecSelfer_containerArrayElem1234)
				yy132 := &x.StreamingConnectionIdleTimeout
				yym133 := z.EncBinary()
				_ = yym133
				if false {
			...
			if yyr2 || yy2arr2 {
				...
				if false {
					...
					r.EncodeString(codecSelferC_UTF81234, string(x.NetworkProvider))
				}
			} else {
				z.EncSendContainerState(codecSelfer_containerMapKey1234)
				r.EncodeString(codecSelferC_UTF81234, string("NetworkProvider"))
				z.EncSendContainerState(codecSelfer_containerMapValue1234)
				yym168 := z.EncBinary()
				_ = yym168
				if false {
			...
			if yyr2 || yy2arr2 {
				z.EncSendContainerState(codecSelfer_containerArrayElem1234)
				if yyq2[82] {
					yy268 := &x.OutOfDiskTransitionFrequency
					yym269 := z.EncBinary()
					_ = yym269
					if false {
				...
				if yyq2[82] {
					...
					z.EncSendContainerState(codecSelfer_containerMapValue1234)
					yy270 := &x.OutOfDiskTransitionFrequency
					yym271 := z.EncBinary()
					_ = yym271
					if false {
			...
			if yyr2 || yy2arr2 {
				z.EncSendContainerState(codecSelfer_containerArrayElem1234)
				if yyq2[90] {
					yy294 := &x.EvictionPressureTransitionPeriod
					yym295 := z.EncBinary()
					_ = yym295
					if false {
				...
				if yyq2[90] {
					...
					z.EncSendContainerState(codecSelfer_containerMapValue1234)
					yy296 := &x.EvictionPressureTransitionPeriod
					yym297 := z.EncBinary()
					_ = yym297
					if false {
	...
	for yyj3 := 0; ; yyj3++ {
		...
		case "CinderConfig":
			if r.TryDecodeAsNil() {
				...
				x.CinderConfig = string(r.DecodeString())
			}
		case "DisableHyperInternalService":
			if r.TryDecodeAsNil() {
				x.DisableHyperInternalService = false
		...
		case "NetworkProvider":
			if r.TryDecodeAsNil() {
				...
				x.NetworkProvider = string(r.DecodeString())
			}
...
func (x *KubeletConfiguration) codecDecodeSelfFromArray(l int, d *codec1978.Decoder) {
	...
	if r.TryDecodeAsNil() {
		...
		yyv155 := &x.StreamingConnectionIdleTimeout
		yym156 := z.DecBinary()
		_ = yym156
		if false {
	...
	if r.TryDecodeAsNil() {
		...
		yyv157 := &x.NodeStatusUpdateFrequency
		yym158 := z.DecBinary()
		_ = yym158
		if false {
	...
	if r.TryDecodeAsNil() {
		...
		yyv177 := &x.RuntimeRequestTimeout
		yym178 := z.DecBinary()
		_ = yym178
		if false {
		} else if z.HasExtensions() && z.DecExt(yyv177) {
		} else if !yym178 && z.IsJSONHandle() {
			z.DecJSONUnmarshal(yyv177)
		} else {
	...
	if r.TryDecodeAsNil() {
		...
		yyv202 := &x.OutOfDiskTransitionFrequency
		yym203 := z.DecBinary()
		_ = yym203
		if false {
	...
	if r.TryDecodeAsNil() {
		...
		if false {
			...
			z.F.DecMapStringStringX(yyv205, false, d)
		}
	}
	yyj110++
	if yyhl110 {
	...
	if r.TryDecodeAsNil() {
		...
		yyv212 := &x.EvictionPressureTransitionPeriod
		yym213 := z.DecBinary()
		_ = yym213
		if false {
...
func (x *KubeControllerManagerConfiguration) codecDecodeSelfFromArray(l int, d *codec1978.Decoder) {
	...
	if r.TryDecodeAsNil() {
		...
		yyv87 := &x.ResourceQuotaSyncPeriod
		yym88 := z.DecBinary()
		_ = yym88
		if false {
	...
	if r.TryDecodeAsNil() {
		...
		yyv91 := &x.PVClaimBinderSyncPeriod
		yym92 := z.DecBinary()
		_ = yym92
		if false {
