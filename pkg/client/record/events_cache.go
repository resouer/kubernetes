...
func NewEventAggregator(lruCacheSize int, keyFunc EventAggregatorKeyFunc, messageFunc EventAggregatorMessageFunc,
	maxEvents int, maxIntervalInSeconds int, clock utiltime.Clock) *EventAggregator {
...
func newEventLogger(lruCacheEntries int, clock utiltime.Clock) *eventLogger {
...
//     times.
func NewEventCorrelator(clock utiltime.Clock) *EventCorrelator {
