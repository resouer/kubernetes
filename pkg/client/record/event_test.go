...
func TestEventf(t *testing.T) {
	...
	clock := &utiltime.FakeClock{time.Now()}
...
func recorderWithFakeClock(eventSource api.EventSource, eventBroadcaster EventBroadcaster, clock utiltime.Clock) EventRecorder {
...
func TestWriteEventError(t *testing.T) {
	...
	eventCorrelator := NewEventCorrelator(utiltime.RealClock{})
