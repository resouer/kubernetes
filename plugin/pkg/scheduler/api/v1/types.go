...
type ExtenderPreemptionResult map[*v1.Node]*Victims

// ExtenderPreemptionArgs represents the arguments needed by the extender to preempt nodes for a pod.
type ExtenderPreemptionArgs struct {
	// Pod being scheduled
	Pod v1.Pod `json:"pod"`
	// Node to pods map generated by scheduler preemption phase
	NodeToPods map[*v1.Node]*Victims `json:"nodeToPods"`
	// Node information
	NodeNameToInfo map[string]*schedulercache.NodeInfo `json:"nodeNameToInfo,omitempty"`
	// PodDisruptionBudget list
	Pdbs []*policy.PodDisruptionBudget `json:"pdbs,omitempty"`
}

// Victims represents:
//   pods:  a group of pods expected to be preempted.
//   numPDBViolations: the counts of violations of PodDisruptionBudget
type Victims struct {
