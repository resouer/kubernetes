...
type SchedulerExtender interface {
	...
	//   3. NodeInfo map for preemption logic to use.
	//   4. PodDisruptionBudget list.
	// The possible changes made by extender may include:
	//   1. Subset of given candidate nodes after Filter phase of extender.
	//   2. More victim pods for every give candidate node after preemption phase of extender.
